At this level (Level_17 -> Level_18) we know that there ar to files in home directory, which is passwords.old and passwords.new.  
...
The upper site is the line in passwords.new which is our password for next level.  
